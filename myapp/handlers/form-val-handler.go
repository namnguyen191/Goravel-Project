...
func (h *Handlers) Form(rw http.ResponseWriter, r *http.Request) {
	...
	err := h.App.Render.Page(rw, r, "form", vars, nil)
	if err != nil {
		h.App.ErrorLog.Println(err)
	}
}

func (h *Handlers) SubmitForm(rw http.ResponseWriter, r *http.Request) {
	err := r.ParseForm()
	if err != nil {
		h.App.ErrorLog.Println(err)
		return
	...
	if !validator.Valid() {
		...
		if err := h.App.Render.Page(rw, r, "form", vars, nil); err != nil {
			h.App.ErrorLog.Println(err)
			return
		}
