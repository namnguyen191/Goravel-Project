...
func doNew(appName string) {
	...
	_, err := git.PlainClone("./"+appName, false, &git.CloneOptions{
		URL:      "https://github.com/namnguyen191/goravel-app.git",
		Progress: os.Stdout,
		Depth:    1,
	})
	...
	env = strings.ReplaceAll(env, "${KEY}", grv.RandomString(32))
	...
	color.Yellow("\tUpdating source file...")
	os.Chdir("./" + appName)
	updateSource()
	...
	color.Green("Your project is ready to GO!")
}
